package com.example.myapplicationendless2;
...
class UserRVAdapter extends RecyclerView.Adapter<UserRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.firstNameTV.setText(userModal.getFirst_name()+" "+userModal.getLast_name());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            firstNameTV = itemView.findViewById(R.id.textView6);



            emailTV = itemView.findViewById(R.id.textView7);

            userIV = itemView.findViewById(R.id.imageView1);
